package com.example.social_network_gradle.repository;
...
public interface Repository<ID, E extends Entity<ID>> {
     ...
     *             if the entity is not valid.
     */
    E update(E entity) throws RepositoryException, ValidationException;

    void increaseStatus(String a, String b) throws SQLException;
}
